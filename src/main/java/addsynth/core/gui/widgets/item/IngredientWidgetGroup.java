...
public final class IngredientWidgetGroup {
  ...
  */
  ...
  public final void drawTooltip(PoseStack matrix, Screen screen, int index, int x, int y, int mouse_x, int mouse_y){
  ...
  public final void drawTooltips(PoseStack matrix, Screen screen, int guiLeft, int[] x, int guiTop, int[] y, int mouse_x, int mouse_y){
    for(i = 0; i < length; i++){
