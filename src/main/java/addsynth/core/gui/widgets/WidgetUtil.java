...
// ========================================= BUTTON RENDER ===========================================
   ...
   * @param height
   */
  public static final void renderButton(PoseStack matrix, AbstractWidget widget, ResourceLocation texture, int texture_x, int texture_y, int width, int height){
   ...
   */
  public static final void renderButton(PoseStack matrix, AbstractWidget widget, ResourceLocation texture, int texture_x, int texture_y, int width, int height, int texture_width, int texture_height){
    common_button_render_setup(texture);
    GuiComponent.blit(matrix, widget.x, widget.y, width, height, texture_x, texture_y, texture_width, texture_height, 256, 256);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into top and bottom parts. */
  public static final void verticalSplitRender(PoseStack matrix, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_height){
    ...
    GuiComponent.blit(matrix, gui_x, gui_y,  width, half_height[0], texture_x, texture_y,  width, half_height[0], 256, 256);
  ...
  public static final void horizontalSplitRender(PoseStack matrix, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_width){
    ...
    GuiComponent.blit(matrix, gui_x,  gui_y, half_width[0], height, texture_x,  texture_y, half_width[0], height, 256, 256);
  ...
  public static final void crossSplitRender(PoseStack matrix, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_width, int max_height){
    ...
    final int texture_x2 = texture_x + max_width  - half_width[1];
    final int texture_y2 = texture_y + max_height - half_height[1];
    GuiComponent.blit(matrix, gui_x,  gui_y,  half_width[0], half_height[0], texture_x,  texture_y,  half_width[0], half_height[0], 256, 256);
    GuiComponent.blit(matrix, gui_x2, gui_y,  half_width[1], half_height[0], texture_x2, texture_y,  half_width[1], half_height[0], 256, 256);
    GuiComponent.blit(matrix, gui_x,  gui_y2, half_width[0], half_height[1], texture_x,  texture_y2, half_width[0], half_height[1], 256, 256);
  ...
  public static final void crossSplitRender(PoseStack matrix, Dimensions gui, Dimensions texture, int scale_width, int scale_height){
    final int[]     gui_half_width  = get_half_lengths(gui.width);
    final int[]     gui_half_height = get_half_lengths(gui.height);
    ...
    final int texture_x2 = texture.x + texture.max_width  - texture_half_width[1];
    final int texture_y2 = texture.y + texture.max_height - texture_half_height[1];
    GuiComponent.blit(matrix, gui.x,  gui.y,  gui_half_width[0], gui_half_height[0], texture.x,  texture.y,  texture_half_width[0], texture_half_height[0], scale_width, scale_height);
    GuiComponent.blit(matrix, gui_x2, gui.y,  gui_half_width[1], gui_half_height[0], texture_x2, texture.y,  texture_half_width[1], texture_half_height[0], scale_width, scale_height);
