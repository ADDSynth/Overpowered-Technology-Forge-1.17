...
// ========================================================================================================
  ...
  public void draw_background_texture(PoseStack matrix){
    RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
    RenderSystem.setShaderTexture(0, GUI_TEXTURE);
    GuiComponent.blit(matrix, guiLeft, guiTop, guiWidth, guiHeight, 0, 0, guiWidth, guiHeight, 256, 256);
  }
   ...
   */
  public void draw_custom_background_texture(PoseStack matrix, final int texture_width, int texture_height){
    RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
    RenderSystem.setShaderTexture(0, GUI_TEXTURE);
    GuiComponent.blit(matrix, guiLeft, guiTop, guiWidth, guiHeight, 0, 0, guiWidth, guiHeight, texture_width, texture_height);
  }
  ...
  public void draw(PoseStack matrix, final int x, final int y, final int u, final int v, final int width, final int height){
    RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
    RenderSystem.setShaderTexture(0, GUI_TEXTURE);
    GuiComponent.blit(matrix, guiLeft + x, guiTop + y, width, height, u, v, width, height, 256, 256);
  }

  /** Draws another part of the gui texture at the coordinates you specify.
   *  If you need more control over how it's drawn, you might as well use the
   *  vanilla blit() function. */
  public void draw(PoseStack matrix, int x, int y, int u, int v, int width, int height, int texture_width, int texture_height){
    RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
    RenderSystem.setShaderTexture(0, GUI_TEXTURE);
    GuiComponent.blit(matrix, guiLeft + x, guiTop + y, width, height, u, v, texture_width, texture_height, 256, 256);
  }
   ...
   */
  @Deprecated
  public void draw_transparent(PoseStack matrix, int x, int y, int u, int v, int width, int height, float opacity){
   ...
   */
  @Deprecated
  public void draw_transparent(PoseStack matrix, int x, int y, int u, int v, int width, int height, int texture_width, int texture_height, float opacity){
    RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, opacity);
    RenderSystem.setShaderTexture(0, GUI_TEXTURE);
    GuiComponent.blit(matrix, x, y, width, height, u, v, texture_width, texture_height, 256, 256);
  }

// ========================================================================================================
  
  public final void draw_title(PoseStack matrix, final Component title){
   ...
   *  <code>ChatFormatting.COLOR.toString()</code>. */
  public static final void draw_text_left(PoseStack matrix, final String text, final int x, final int y){
  ...
  public final void draw_text_center(PoseStack matrix, final String text, final int y){
   ...
   * @param y
   */
  public final static void draw_text_center(PoseStack matrix, final String text, final int x, final int y){
   ...
   *  This will render the string in a different color if you prefix the string with
   *  <code>TextFormatting.COLOR.toString()</code>. */
  public final void draw_text_right(PoseStack matrix, final String text, final int y){
    font.draw(matrix, text, right_edge - font.width(text), y, text_color);
  }

  /** This will render the string in a different color if you prefix the string with
   *  <code>TextFormatting.COLOR.toString()</code>. */
  public static final void draw_text_right(PoseStack matrix, final String text, final int x, final int y){
