...
public final class WorldTime {
  ...
  public static final long getTimeOfDay(final Level world){
    return world.getDayTime() % minecraft_day_in_ticks;
  }

  public static final long getNextDay(final Level world){
  ...
  public static final long getNextNight(final Level world){
    final long world_time = world.getDayTime();
